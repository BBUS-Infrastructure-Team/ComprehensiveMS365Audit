    ...
    try {
        ...
        try {
            ...
            if ($roleDefinitions) {
                ...
                Write-Host "Found $($roleDefinitions.Count) Intune role definitions" -ForegroundColor Green
                
                if ($roleDefinitions) {
                    $AllAssignments = Get-RoleAssignmentsForService -RoleDefinitions $roleDefinitions -ServiceName "InTune" -IncludePIM
                }
