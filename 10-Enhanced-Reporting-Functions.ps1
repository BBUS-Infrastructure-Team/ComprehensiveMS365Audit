...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>$OrganizationName | As of $($DataDate.ToLongDateString())</p>
        </div>
...
"@
    ...
    $html += @"
        <div class="footer">
            ...
            <p>Based on data generated on: $($DataDate.ToLongDateString()) | Report Generated: $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')</p>
...
function Export-M365AuditExcelReport {
    ...
    try {
        ...
        $ReportDateString = $ReportDate.ToString("MMMM dd, yyyy 'at' HH;MM")
        ...
        if ($Summary.assignmentTypes.Count -lt 8) {
            $StartRow += 11
        } else {
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="date">$OrganizationName | As of $($DataDate.ToLongDateString())</div>
        </div>
"@
    ...
    $html += @"
        <div class="footer">
            <div class="generated-info">
                ...
                <strong>Data Generated:</strong> $($DataDate.ToLongDateString()) |
